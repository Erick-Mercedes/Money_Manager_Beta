...
class _Add_ScreenState extends State<Add_Screen> {
  /*--Aqui inicia-- Declarar una instancia de FlutterLocalNotificationsPlugin */
  ...
  Future<void> _showNotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(
      ...
      'Monto de Actividad \$${amount_c.text}',
      platformChannelSpecifics,
    );
  }
  /**--Aqui termina -- el codigo para que la notificaciones funcione---- */
